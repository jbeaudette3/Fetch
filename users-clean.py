# load data
df = pd.DataFrame(pd.read_json('/content/drive/MyDrive/Fetch Interview/users.json', lines = True))
...
flat_users.to_csv('/content/drive/MyDrive/Fetch Interview/cleaned_users.tsv', sep='\t')
